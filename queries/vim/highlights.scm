; NOTE: Full override of the Neovim runtime vim/highlights.scm to remove
; the "substitute" keyword which doesn't exist in the current vim parser
; grammar. This fixes the error:
;   "Query error at 130:4. Invalid node type "substitute""
; Once the parser and runtime queries are back in sync (e.g. after
; a Neovim snap update), this file can be safely deleted.
